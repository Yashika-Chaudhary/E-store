			...
			<div class="row" style="margin-top:80px;">
				<div class="container text-justify">
					<div class="col-lg-10">
						...
						<p>E-store provides with latest mobile phones at reasonable prices. The store fulfills the demand of buyers and ensures best services within the time constraint. We are rady to help at any time.</p>
					</div>
					<div class="col-lg-2">
			...
			<div class="row">
				<div class="container">
					...
					<div class="col-lg-4">
						...
						<p>500 MAXmin, </p>
						<p>22-A saket, delhi,</p>
						<p>India</p>
						<p>Phone:(91) 78 666 444</p>
